...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Default bed with 4mm borosilicate Glass (Trevor Cockayne)
  #define DEFAULT_bedKp 216.97
  #define DEFAULT_bedKi 36.28
  #define DEFAULT_bedKd 324.37
...
#define BLTOUCH
  ...
  //#define BLTOUCH_DELAY 100   // Minimum Command delay (ms). Enable and increase if needed
